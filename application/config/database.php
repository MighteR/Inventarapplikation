...
$db['development']['database'] = 'inventarapplikation';
...
$db['production']['hostname'] = 'marcmag.mysql.db.internal';
$db['production']['username'] = 'marcmag_inv';
$db['production']['password'] = 'ktsihe10';
$db['production']['database'] = 'marcmag_inventarapplikation';
